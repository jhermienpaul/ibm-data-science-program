...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
            ...
            value='Select-year', # value=None
            placeholder='Select-year'
        )),
    # TASK 3: Add a division for output display
    html.Div([
        html.Div(id='output-container', className='chart-grid', style={'display': 'flex'}),])
])

# TASK 4: Creating Callbacks
...
#TASK 5: Create and display graphs for Recession Report Statistics
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        # Returning the graphs for displaying data
        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display': 'flex'}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'display': 'flex'})
            ]

# TASK 6: Create and display graphs for Yearly Report Statistics
